...
public class PessoaAlteracaoDto {
	...
	public @NotBlank(message = "o nome completo é obrigatório") @Size(max = 100) @Email String getEmail() {
		return email;
	}

	public void setEmail(@NotBlank(message = "o nome completo é obrigatório") @Size(max = 100) @Email String email) {
		this.email = email;
	}
